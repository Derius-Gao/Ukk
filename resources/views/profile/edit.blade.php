              ...
              <div class="row">
                <div class="col-md-7 pr-1">
                  <div class="form-group">
                    ...
                    <input class="form-control @error('password') is-invalid @enderror" placeholder="Password Baru" type="password" name="password">
                    @error('password')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
              <div class="col-md-7 pr-1">
                <div class="form-group">
                  ...
                  <input class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Konfirmasi Password Baru" type="password" name="password_confirmation">
